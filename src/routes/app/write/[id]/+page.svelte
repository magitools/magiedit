...
<div class="flex h-full w-full flex-col relative p-4">
	...
	<div class="h-full w-full grid grid-cols-1 md:grid-cols-2 group gap-4" data-source={source}>
		...
		/>
		<div
			class="w-full h-full max-h-[100%] overflow-y-auto prose p-4 bg-primary text-primary-foreground block group-data-[source=true]:hidden group-data-[source=false]:block md:group-data-[source=true]:block md:group-data-[source=false]:block"
		>
